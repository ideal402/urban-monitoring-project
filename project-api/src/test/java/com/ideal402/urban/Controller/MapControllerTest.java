...
//
//        CustomMapInfo request = new CustomMapInfo(1L, "test",1D,1D,1,1,1,OffsetDateTime.now());
//
//        List<CustomMapInfo> responseList = Collections.singletonList(request);
//
...
//                .andExpect(jsonPath("$[0].airQualityLevel").value(1))
//                .andDo(print());
//    }
//
//    @Test
